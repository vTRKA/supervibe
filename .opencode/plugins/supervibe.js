...
// Auto-registers skills directory and injects bootstrap context.
{
  name: "supervibe",
  version: "2.0.112",
  description: "Specialist agents (91), trigger-safe workflow routing, worktree-ready autonomous loops, design intelligence, code graph, semantic RAG, project memory, confidence gates.",
  hooks: {
