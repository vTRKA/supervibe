...
description: "Use WHEN designing API error responses TO pick a consistent envelope (RFC 7807 problem+json / GraphQL union / gRPC status), define retry semantics, partial failure shapes"
