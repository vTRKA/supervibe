...
description: >-
  Curated cross-stack best practices as of 2026 — TypeScript strict, async/await
  over callbacks, immutable defaults, structured logging, no implicit any.
  Triggers: 'best practices', 'актуально', 'современные паттерны'.
applies-to:
  - any
mandatory: false
version: 1
