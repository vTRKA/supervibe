...
| Autonomous loop | `/supervibe-loop` turns a reviewed plan, PRD, epic, or validation request into a goal-until-complete, visible, cancellable agent loop with task graph scheduling, work-item templates, provider permission audit, side-effect ledger, 9/10 system acceptance, and final user goal confirmation |
...
```
[supervibe] welcome  plugin v2.0.101 initialized for this project
...
/supervibe-loop --accept-goals --file .supervibe/memory/loops/example-run/state.json --accepted-by <name>
/supervibe-loop --reject-goals --file .supervibe/memory/loops/example-run/state.json --feedback "what is missing"
/supervibe-loop --fork-checkpoint --file .supervibe/memory/loops/example-run/state.json
