...
Supervibe v2.0.116 release candidates must pass the local release security gate before publishing or tagging.
...
Current v2.0.116 status: no active vulnerability exceptions are recorded.
