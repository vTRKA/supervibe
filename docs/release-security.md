...
Supervibe v2.1.42 release candidates must pass the local release security gate before publishing or tagging.
...
Current v2.1.42 status: no active vulnerability exceptions are recorded.
