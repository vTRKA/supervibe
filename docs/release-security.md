...
Supervibe v2.0.44 release candidates must pass the local release security gate before publishing or tagging.
...
Current v2.0.44 status: no active vulnerability exceptions are recorded.
