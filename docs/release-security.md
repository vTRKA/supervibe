...
Supervibe v2.0.6 release candidates must pass the local release security gate before publishing or tagging.
...
Current v2.0.6 status: no active vulnerability exceptions are recorded.
