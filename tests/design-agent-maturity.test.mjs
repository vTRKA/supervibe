...
const PASSING_CHECKS = Object.freeze({
  ...
  workflow: {
    ...
    capabilityContracts: { pass: true },
    styleboardQa: { pass: true },
    dynamicQuestions: { pass: true },
    variantSetValidator: true,
    variantSetScript: true,
    bypassGuards: {
      promotionProvenance: true,
      qualityGateReceiptValidation: true,
      prewritePrototypeBuilderGate: true,
      activeReceiptGate: true,
      mediaCapabilityStages: true,
      feedbackE2E: true,
    },
  },
  creative: {
