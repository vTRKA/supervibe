...
test("agent technology readiness covers the eight researched recommendations", async () => {
  ...
  assert.ok(report.recommendations.some((item) => item.id === "agent-codegraph-index-readiness"));
