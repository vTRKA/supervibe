...
test("release security report includes provenance and rollback manifest status", () => {
  const audit = auditReleaseSecurityData({
    packageJson: { version: "2.0.37" },
    packageLock: { version: "2.0.37" },
    readme: "v2.0.37 docs/release-security.md docs/third-party-licenses.md docs/install-integrity.md",
    changelog: "Release security and install integrity updates.",
    releaseDocs: {
      releaseSecurity: "v2.0.37 commit SHA npm run audit:release-security vulnerability exceptions",
    ...
    releaseManifest: { status: "local-dev", packageVersion: "2.0.37" },
