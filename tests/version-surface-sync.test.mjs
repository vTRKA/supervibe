...
test("release-facing version surfaces are synchronized to 2.0.61", async () => {
...
test("getting-started local install examples use the current 2.0.61 cache path", async () => {
