...
const TARGET_VERSION = "2.1.44";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-17";

test("release-facing version surfaces are synchronized to 2.1.44", async () => {
...
test("getting-started local install examples use the current 2.1.44 cache path", async () => {
