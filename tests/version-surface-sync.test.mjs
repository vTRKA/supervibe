...
test("release-facing version surfaces are synchronized to 2.1.3", async () => {
...
test("getting-started local install examples use the current 2.1.3 cache path", async () => {
