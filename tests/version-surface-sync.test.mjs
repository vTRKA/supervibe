...
test("release-facing version surfaces are synchronized to 2.0.22", async () => {
...
test("getting-started local install examples use the current 2.0.22 cache path", async () => {
