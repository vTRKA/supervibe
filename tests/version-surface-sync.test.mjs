...
test("release-facing version surfaces are synchronized to 2.0.15", async () => {
...
test("getting-started local install examples use the current 2.0.15 cache path", async () => {
