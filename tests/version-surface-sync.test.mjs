...
const TARGET_VERSION = "2.0.48";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");

test("release-facing version surfaces are synchronized to 2.0.48", async () => {
...
test("getting-started local install examples use the current 2.0.48 cache path", async () => {
