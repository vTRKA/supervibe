...
const TARGET_VERSION = "2.1.31";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-14";

test("release-facing version surfaces are synchronized to 2.1.31", async () => {
...
test("getting-started local install examples use the current 2.1.31 cache path", async () => {
