...
const TARGET_VERSION = "2.0.71";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-04";

test("release-facing version surfaces are synchronized to 2.0.71", async () => {
...
test("getting-started local install examples use the current 2.0.71 cache path", async () => {
