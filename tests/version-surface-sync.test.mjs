...
const TARGET_VERSION = "2.0.93";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-06";

test("release-facing version surfaces are synchronized to 2.0.93", async () => {
...
test("getting-started local install examples use the current 2.0.93 cache path", async () => {
