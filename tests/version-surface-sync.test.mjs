...
const TARGET_VERSION = "2.1.29";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-13";

test("release-facing version surfaces are synchronized to 2.1.29", async () => {
...
test("getting-started local install examples use the current 2.1.29 cache path", async () => {
