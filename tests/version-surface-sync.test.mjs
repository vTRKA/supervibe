...
const TARGET_VERSION = "2.1.10";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-10";

test("release-facing version surfaces are synchronized to 2.1.10", async () => {
...
test("getting-started local install examples use the current 2.1.10 cache path", async () => {
