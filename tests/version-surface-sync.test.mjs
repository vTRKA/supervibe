...
const TARGET_VERSION = "2.1.41";
const TARGET_VERSION_PATTERN = TARGET_VERSION.replaceAll(".", "\\.");
const TARGET_RELEASE_DATE = "2026-05-17";

test("release-facing version surfaces are synchronized to 2.1.41", async () => {
...
test("getting-started local install examples use the current 2.1.41 cache path", async () => {
