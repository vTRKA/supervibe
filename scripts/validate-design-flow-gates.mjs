...
const RULES = Object.freeze([
  {
    ...
    required: [
      ...
      new RegExp("Creative exploration mockups are drafts, not official prototypes", "i"),
      /\.supervibe\/artifacts\/mockups\/<slug>/i,
      /creative-director.*ux-ui-designer.*copywriter.*prototype-builder.*ui-polish-reviewer.*accessibility-reviewer.*quality-gate-reviewer/is,
      /keyboard\/focus\/focus-trap/i,
      /WCAG contrast audit/i,
      /approve \/ revise \/ compare another direction \/ stop/i,
