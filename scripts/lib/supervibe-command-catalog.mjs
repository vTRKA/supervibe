...
const SLASH_COMMAND_SHORTCUTS = Object.freeze([
  ...
  },
  {
    ...
    commandArgs: "--from-plan <plan-path> --start --fast-session",
    nextAction: "Create the active work graph from the approved loop-ready plan, show ready tasks, then dispatch or claim the next ready task.",
  },
  {
...
const COMMAND_SHORTCUTS = Object.freeze([
  ...
  {
    id: "approved-plan-graph-dispatch",
    intent: "task_graph_create_from_plan",
    title: "Create graph, epics, and tasks from an existing plan",
    command: "/supervibe-loop --from-plan <plan-path> --start --fast-session",
    description: "Route fast-start graph creation wording to the loop atomizer instead of writing another plan.",
    agentContract: copyCommandAgentContract(),
    agentProfile: getCommandAgentProfile("/supervibe-loop"),
    aliases: [
      "from the plan create epics tasks and dispatch agents",
      "create epics and tasks from the plan for fast start",
      "create graph from plan and dispatch agents",
      "start work from plan and dispatch agents",
      "start work from the plan and dispatch agents",
      "\u0441\u043e\u0437\u0434\u0430\u0439 \u044d\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0438\u0437 \u043f\u043b\u0430\u043d\u0430",
      "\u0441\u043e\u0437\u0434\u0430\u0439 \u0435\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0438\u0437 \u043f\u043b\u0430\u043d\u0430",
      "\u0438\u0437 \u043f\u043b\u0430\u043d\u0430 \u0441\u043e\u0437\u0434\u0430\u0439 \u0433\u0440\u0430\u0444 \u044d\u043f\u0438\u043a\u0438 \u0437\u0430\u0434\u0430\u0447\u0438",
      "\u0438\u0437 \u043f\u043b\u0430\u043d\u0430 \u0441\u043e\u0437\u0434\u0430\u0439 graph epics tasks and dispatch agents",
      "\u0438\u0437 \u043e\u0431\u044b\u0447\u043d\u043e\u0433\u043e \u043f\u043b\u0430\u043d\u0430 \u0441\u043e\u0437\u0434\u0430\u0439 graph epics tasks and dispatch agents",
    ],
    keywordGroups: [
      ["from the plan", "from plan", "existing plan", "approved plan", "loop-ready plan", "\u0438\u0437 \u043f\u043b\u0430\u043d\u0430", "\u0438\u0437 \u043e\u0431\u044b\u0447\u043d\u043e\u0433\u043e \u043f\u043b\u0430\u043d\u0430", "\u043f\u043e \u043f\u043b\u0430\u043d\u0443"],
      ["graph", "work graph", "epics", "tasks", "\u0433\u0440\u0430\u0444", "\u044d\u043f\u0438\u043a\u0438", "\u0435\u043f\u0438\u043a\u0438", "\u0437\u0430\u0434\u0430\u0447", "\u0437\u0430\u0434\u0430\u0447\u0438"],
      ["create", "build", "start", "fast start", "dispatch", "assign", "\u0441\u043e\u0437\u0434\u0430\u0439", "\u0441\u043e\u0437\u0434\u0430\u0442\u044c", "\u0437\u0430\u043f\u0443\u0441\u043a", "\u0431\u044b\u0441\u0442\u0440", "\u0440\u0430\u0437\u0434\u0430\u0439", "\u0440\u0430\u0437\u0434\u0430\u0442\u044c", "\u0440\u0430\u0441\u043a\u0438\u0434\u0430\u0439"],
    ],
    requiredGroupIndexes: [0, 1, 2],
    priorityPhrases: ["from the plan", "create epics and tasks from the plan", "\u044d\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0438\u0437 \u043f\u043b\u0430\u043d\u0430", "\u0435\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0438\u0437 \u043f\u043b\u0430\u043d\u0430"],
    followUpCommands: ["/supervibe-loop --resume-dispatch"],
    mutationRisk: "writes-tracker",
    directRoute: true,
    commandId: "/supervibe-loop",
    commandArgs: "--from-plan <plan-path> --start --fast-session",
    nextAction: "Create the active work graph from the existing approved plan, show ready tasks, then dispatch the first ready task.",
  },
  {
    id: "claim-next-ready-task",
    intent: "task_graph_claim_ready",
    title: "Claim the next ready graph task",
    command: "/supervibe-loop --claim-ready",
    description: "Route ready-task pickup wording to the claim-ready loop path.",
    agentContract: copyCommandAgentContract(),
    agentProfile: getCommandAgentProfile("/supervibe-loop"),
    aliases: [
      ...
      "claim ready task",
      "pick next ready work item",
      "\u0432\u043e\u0437\u044c\u043c\u0438 \u0441\u043b\u0435\u0434\u0443\u044e\u0449\u0443\u044e \u0433\u043e\u0442\u043e\u0432\u0443\u044e \u0437\u0430\u0434\u0430\u0447\u0443",
      "\u0437\u0430\u0431\u0435\u0440\u0438 \u0441\u043b\u0435\u0434\u0443\u044e\u0449\u0443\u044e ready \u0437\u0430\u0434\u0430\u0447\u0443",
    ],
    keywordGroups: [
      ["take", "claim", "pick", "get", "\u0432\u043e\u0437\u044c\u043c\u0438", "\u0437\u0430\u0431\u0435\u0440\u0438"],
      ["next", "ready", "\u0441\u043b\u0435\u0434\u0443\u044e\u0449", "\u0433\u043e\u0442\u043e\u0432"],
      ["task", "work item", "ready task", "\u0437\u0430\u0434\u0430\u0447", "\u0437\u0430\u0434\u0430\u0447\u0443"],
    ],
    requiredGroupIndexes: [0, 1, 2],
    mutationRisk: "delegates-to-slash-command",
    directRoute: true,
    commandId: "/supervibe-loop",
    commandArgs: "--claim-ready",
    nextAction: "Claim the next ready work item from the active graph.",
  },
  {
    id: "dispatch-ready-work-to-agents",
    intent: "task_graph_resume",
    title: "Dispatch ready graph work to agents",
    command: "/supervibe-loop --resume-dispatch",
    description: "Route fast agent-dispatch wording to the ready-task dispatcher instead of planning or diagnostics.",
    agentContract: copyCommandAgentContract(),
    agentProfile: getCommandAgentProfile("/supervibe-loop"),
    aliases: [
      "dispatch ready tasks to agents",
      "assign ready work to agents",
      "\u0431\u044b\u0441\u0442\u0440\u043e \u0440\u0430\u0437\u0434\u0430\u0439 \u044d\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0430\u0433\u0435\u043d\u0442\u0430\u043c",
      "\u0431\u044b\u0441\u0442\u0440\u043e \u0440\u0430\u0437\u0434\u0430\u0439 \u0435\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0430\u0433\u0435\u043d\u0442\u0430\u043c",
      "\u0431\u044b\u0441\u0442\u0440\u043e \u0440\u0430\u0437\u0434\u0430\u0442\u044c \u0435\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0430\u0433\u0435\u043d\u0442\u0430\u043c\u0438",
      "\u0440\u0430\u0437\u0434\u0430\u0439 \u0437\u0430\u0434\u0430\u0447\u0438 \u0430\u0433\u0435\u043d\u0442\u0430\u043c",
    ],
    keywordGroups: [
      ["dispatch", "assign", "fan out", "\u0440\u0430\u0437\u0434\u0430\u0439", "\u0440\u0430\u0437\u0434\u0430\u0442\u044c", "\u0440\u0430\u0441\u043a\u0438\u0434\u0430\u0439", "\u0440\u0430\u0441\u043f\u0440\u0435\u0434\u0435\u043b\u0438"],
      ["agent", "agents", "subagents", "\u0430\u0433\u0435\u043d\u0442", "\u0430\u0433\u0435\u043d\u0442\u044b", "\u0430\u0433\u0435\u043d\u0442\u0430\u043c", "\u0430\u0433\u0435\u043d\u0442\u0430\u043c\u0438"],
      ["ready tasks", "ready work", "tasks", "work items", "epics", "\u0437\u0430\u0434\u0430\u0447", "\u0437\u0430\u0434\u0430\u0447\u0438", "\u044d\u043f\u0438\u043a\u0438", "\u0435\u043f\u0438\u043a\u0438"],
    ],
    requiredGroupIndexes: [0, 1, 2],
    followUpCommands: [],
    mutationRisk: "delegates-to-slash-command",
    directRoute: true,
    commandId: "/supervibe-loop",
    commandArgs: "--resume-dispatch",
    nextAction: "Resume the active graph and dispatch the next ready task to a real agent, with status fallback if no graph is active.",
  },
  {
  ...
  },
  {
    ...
    aliases: [
      ...
      "create a temporary plan with all tasks and run reviewers without executing it",
  ...
  {
    id: "pre-spec-summary-gate",
    intent: "pre_spec_summary_gate",
    title: "Show pre-spec summary before durable spec write",
    command: "/supervibe-brainstorm --summary-gate --stage pre-spec",
    description: "Route explicit pre-spec summary requests to the stable approval gate before creating a spec.",
    aliases: ["pre-spec summary", "summary before spec", "show summary before requirements spec", "\u0441\u0430\u043c\u043c\u0430\u0440\u0438 \u043f\u0435\u0440\u0435\u0434 \u0441\u043f\u0435\u043a\u043e\u0439"],
    keywordGroups: [["summary", "resume", "\u0441\u0430\u043c\u043c\u0430\u0440\u0438"], ["pre-spec", "before spec", "requirements", "spec", "\u0441\u043f\u0435\u043a\u0430"], ["approval", "approve", "gate", "\u0443\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c"]],
    requiredGroupIndexes: [0, 1],
    agentContract: copyCommandAgentContract(),
    agentProfile: getCommandAgentProfile("/supervibe-brainstorm"),
    mutationRisk: "delegates-to-slash-command",
    directRoute: false,
    commandId: "/supervibe-brainstorm",
    commandArgs: "--summary-gate --stage pre-spec",
    nextAction: "Run /supervibe-brainstorm --summary-gate --stage pre-spec and wait for latest-user approval before spec creation.",
  },
  {
    id: "post-spec-summary-gate",
    intent: "post_spec_summary_gate",
    title: "Show post-spec summary after spec creation",
    command: "/supervibe-brainstorm --summary-gate --stage post-spec",
    description: "Route explicit post-spec summary requests to the durable source-bound summary before planning.",
    aliases: ["post-spec summary", "summary after spec", "show what was added after spec", "\u0441\u0430\u043c\u043c\u0430\u0440\u0438 \u043f\u043e\u0441\u043b\u0435 \u0441\u043f\u0435\u043a\u0438"],
    keywordGroups: [["summary", "resume", "\u0441\u0430\u043c\u043c\u0430\u0440\u0438"], ["post-spec", "after spec", "spec", "\u0441\u043f\u0435\u043a\u0430"], ["added", "why", "next", "\u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043e"]],
    requiredGroupIndexes: [0, 1],
    agentContract: copyCommandAgentContract(),
    agentProfile: getCommandAgentProfile("/supervibe-brainstorm"),
    mutationRisk: "delegates-to-slash-command",
    directRoute: false,
    commandId: "/supervibe-brainstorm",
    commandArgs: "--summary-gate --stage post-spec",
    nextAction: "Run /supervibe-brainstorm --summary-gate --stage post-spec to show what changed, why, visual map, and next planning choices.",
  },
  {
    id: "pre-plan-summary-gate",
    intent: "pre_plan_summary_gate",
    title: "Show pre-plan summary before durable plan write",
    command: "/supervibe-plan --summary-gate --stage pre-plan",
    description: "Route explicit pre-plan summary requests to the stable approval gate before creating a plan.",
    aliases: ["pre-plan summary", "summary before plan", "show summary before implementation plan", "\u0441\u0430\u043c\u043c\u0430\u0440\u0438 \u043f\u0435\u0440\u0435\u0434 \u043f\u043b\u0430\u043d\u043e\u043c"],
    keywordGroups: [["summary", "resume", "\u0441\u0430\u043c\u043c\u0430\u0440\u0438"], ["pre-plan", "before plan", "implementation plan", "plan", "\u043f\u043b\u0430\u043d"], ["approval", "approve", "gate", "\u0443\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c"]],
    requiredGroupIndexes: [0, 1],
    agentContract: copyCommandAgentContract(),
    agentProfile: getCommandAgentProfile("/supervibe-plan"),
    mutationRisk: "delegates-to-slash-command",
    directRoute: false,
    commandId: "/supervibe-plan",
    commandArgs: "--summary-gate --stage pre-plan",
    nextAction: "Run /supervibe-plan --summary-gate --stage pre-plan and wait for latest-user approval before plan creation.",
  },
  {
    id: "post-plan-summary-gate",
