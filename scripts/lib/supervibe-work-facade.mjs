...
export function formatWorkFacadeHelp() {
  return [
    ...
    "  sv work atomize <plan.md> --plan-review-passed",
    ...
    "  atomize|priority|ready|next|claim|claim-ready|run-ready|dispatch -> matching supervibe-loop work graph action",
    "  complete|close|block|unblock|skip|defer|create|edit|delete|split|reparent|deps|dep-add|dep-remove|why|proof -> matching work-item action or view",
