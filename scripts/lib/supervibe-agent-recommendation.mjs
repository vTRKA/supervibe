...
function renderManagedInstruction({ hostSelection, fingerprint, agentProfile, recommendedAgents, optionalAgents }) {
  ...
  return [
    ...
    "- In Codex, invoke required specialists through `spawn_agent`, then record the returned agent id with `node <resolved-supervibe-plugin-root>/scripts/agent-invocation.mjs log --agent <agent-id> --host codex --host-invocation-id <runtime-id> --task <summary> --confidence <0-10>` before issuing receipts.",
