...
export function formatAgentRosterMarkdown(roster = { agents: [], count: 0, categories: [] }) {
  const lines = [
    ...
    "",
    "Do not invoke agents for a one-line terminal lookup, a trivial typo, a request",
    "that only needs a known file path, or work already owned by an active",
    "command-owned lifecycle. Do not use a generic agent to emulate a named",
