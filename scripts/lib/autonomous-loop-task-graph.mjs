...
export function normalizeGraphTask(task = {}, sourceOrder = 0, options = {}) {
  ...
  return {
    ...
    contractChecklist: task.contractChecklist || task.contract_checklist || [],
    scopeSafetyChecklist: task.scopeSafetyChecklist || task.scope_safety_checklist || [],
    productionReadinessChecklist: task.productionReadinessChecklist || task.production_readiness_checklist || [],
    tenOfTenChecklist: task.tenOfTenChecklist || task.ten_of_ten_checklist || [],
...
export function graphToFlatTasks(input = {}) {
  return createTaskGraph(input).tasks.map((task) => ({
    ...
    contractChecklist: [...task.contractChecklist],
    scopeSafetyChecklist: [...task.scopeSafetyChecklist],
    productionReadinessChecklist: [...task.productionReadinessChecklist],
    tenOfTenChecklist: [...task.tenOfTenChecklist],
