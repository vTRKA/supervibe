...
export const WORKFLOW_SUMMARY_STAGE_CONFIG = Object.freeze({
  ...
  "post-spec": stage({
    ...
    nextRecommendedCommand: "/supervibe-plan --from-brainstorm <spec-path>",
  ...
  "post-plan": stage({
    ...
    nextRecommendedCommand: "/supervibe-plan --review <plan-path>",
    approveChoiceId: "approve-post-plan-summary",
    reviseChoiceId: "revise-plan-before-review",
    stopChoiceId: "stop-after-plan",
    choices: [
      ["approve-post-plan-summary", "Approve plan summary and review", "Allows the workflow to move into plan review with the current plan summary.", true],
      ["revise-plan-before-review", "Revise plan first", "Keeps the workflow on the implementation plan before review starts.", false],
