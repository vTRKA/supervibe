...
export function buildProviderDefaultEntries(provider = {}) {
  ...
  return [
    ...
    keyEntry(["features", "hooks"], true, "features.hooks"),
    keyEntry(["features", "codex_hooks"], true, "features.codex_hooks"),
    keyEntry(["features", "plugin_hooks"], true, "features.plugin_hooks"),
    ...
    keyEntry(["apps", "_default", "enabled"], true, "apps._default.enabled"),
    {
      ...
      surface: "hooks",
      values: { matcher: "startup|resume|clear|compact" },
      match: { matcher: "startup|resume|clear|compact" },
    },
    {
      kind: "arrayTable",
      path: ["hooks", "SessionStart", "hooks"],
      surface: "hooks",
      values: {
        type: "command",
      ...
      match: { type: "command", command: "supervibe hook session-start" },
    },
    {
      kind: "arrayTable",
      path: ["hooks", "PostToolUse"],
      surface: "hooks",
      values: { matcher: "Bash|apply_patch|Edit|Write" },
      match: { matcher: "Bash|apply_patch|Edit|Write" },
    },
    {
      kind: "arrayTable",
      path: ["hooks", "PostToolUse", "hooks"],
      surface: "hooks",
      values: {
        type: "command",
      ...
      match: { type: "command", command: "supervibe hook post-edit" },
    },
    {
      kind: "arrayTable",
