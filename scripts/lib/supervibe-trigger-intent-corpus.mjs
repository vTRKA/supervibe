...
const TRIGGER_INTENT_CORPUS = Object.freeze([
  ...
  {
    id: "en-browser-first-visual",
    phrase: "explain this system visually with a browser-first preview before implementation",
    locale: "en",
    ...
    mutationRisk: "none",
    prerequisites: ["user-request"],
    nextQuestionIncludes: "Step 1/1: show a browser-first visual explanation with text fallback before planning?",
    requiredSafety: [...baseSafety, "browser-first-visual-preview", "text-fallback", "no-unverified-implementation-claims"],
  },
  {
