...
const TRIGGER_INTENT_CORPUS = Object.freeze([
  ...
  {
    id: "en-execute-approved-user-approved-loop-ready-plan",
    phrase: "execute the approved loop-ready implementation plan after graph creation",
    locale: "en",
    intent: "execute_plan",
    phase: "execution",
    ...
    prerequisites: ["approved-user-approved-loop-ready-plan"],
    nextQuestionIncludes: "Step 1/1: execute the approved user-approved loop-ready plan phase by phase?",
  ...
  {
    id: "ru-fast-plan-graph-typo-epics",
    phrase: "\u0441\u043e\u0437\u0434\u0430\u0439 \u0435\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0438\u0437 \u043f\u043b\u0430\u043d\u0430 \u0434\u043b\u044f \u0431\u044b\u0441\u0442\u0440\u043e\u0433\u043e \u0441\u0442\u0430\u0440\u0442\u0430 \u0440\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u043a\u0438",
    locale: "ru",
    ...
    mutationRisk: "writes-tracker",
    prerequisites: ["user-approved-loop-ready-plan"],
    nextQuestionIncludes: "Step 1/1: create the graph, epics, and tasks from the approved plan?",
    requiredSafety: baseSafety,
  },
  {
    id: "ru-dispatch-epics-agents-typo",
    phrase: "\u0431\u044b\u0441\u0442\u0440\u043e \u0440\u0430\u0437\u0434\u0430\u0442\u044c \u0435\u043f\u0438\u043a\u0438 \u0438 \u0437\u0430\u0434\u0430\u0447\u0438 \u0430\u0433\u0435\u043d\u0442\u0430\u043c\u0438",
    locale: "ru",
    intent: "task_graph_resume",
    phase: "execution",
    command: "/supervibe-loop --resume-dispatch",
    ...
    mutationRisk: "none",
    prerequisites: ["active-work-graph-or-loop-state"],
    nextQuestionIncludes: "Step 1/1: dispatch the next ready graph work to agents?",
    requiredSafety: baseSafety,
  },
  {
    id: "en-plan-graph-dispatch",
    phrase: "from the plan create epics tasks and dispatch agents",
    locale: "en",
    intent: "task_graph_create_from_plan",
    phase: "plan_approved",
    command: "/supervibe-loop --from-plan <plan-path> --start --fast-session",
  ...
  },
  {
    ...
    mutationRisk: "none",
    prerequisites: ["plan-path-or-plan-content"],
    nextQuestionIncludes: "Step 1/1: run optional deeper plan review?",
    requiredSafety: baseSafety,
  },
  {
    id: "en-atomize-plan",
  ...
  },
  {
    ...
    mutationRisk: "none",
    prerequisites: ["active-work-graph-or-loop-state"],
    nextQuestionIncludes: "Step 1/1: dispatch the next ready task for the active epic/task graph, with status fallback if no dispatch is available?",
    requiredSafety: baseSafety,
  },
  {
