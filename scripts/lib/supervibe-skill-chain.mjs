...
export const WORKFLOW_EDGES = Object.freeze({
  ...
  brainstorm: {
    ...
    why: "A brainstorm is not executable until it becomes a loop-ready implementation plan.",
  },
  plan: {
    phase: "plan",
    ...
    artifactKind: "user-approved-loop-ready-plan",
    stopCondition: "ask-before-work-item-atomization",
    questionEn: "Step 1/1: create the work graph from the approved loop-ready plan?",
    questionRu: "Step 1/1: create the work graph from the approved loop-ready plan?",
    why: "A user-approved loop-ready plan can become durable, claimable work items without a mandatory review ritual.",
  },
  "plan-review": {
    phase: "plan-review",
    nextPhase: "work-item-atomization",
    command: "/supervibe-loop --atomize-plan <plan-path> --user-approved-plan",
    skill: "supervibe:writing-plans",
    artifactKind: "strict-reviewed-plan",
    stopCondition: "ask-before-work-item-atomization",
    questionEn: "Step 1/1: atomize the reviewed or user-approved plan into an epic and child work items?",
    questionRu: "Шаг 1/1: разбить план на атомарные задачи и epic?",
    why: "A reviewed or user-approved loop-ready plan can become durable, claimable work items.",
  },
  "work-item-atomization": {
