...
export const WORKFLOW_EDGES = Object.freeze({
  ...
  "work-item-atomization": {
    ...
    nextPhase: "worktree-setup",
    command: "/supervibe-loop --epic --worktree",
    skill: "supervibe:using-git-worktrees",
    artifactKind: "epic-with-atomic-work-items",
    stopCondition: "ask-before-worktree-setup",
    questionEn: "Next step is an isolated worktree preflight. Proceed?",
    questionRu: "Следующий шаг - preflight отдельного worktree. Переходим?",
    why: "Long autonomous runs need isolated branch/path ownership and cleanup controls.",
  },
  "worktree-setup": {
