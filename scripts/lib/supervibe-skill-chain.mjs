...
export const WORKFLOW_EDGES = Object.freeze({
  intake: {
    ...
    questionEn: "Next step is brainstorming the requirements. Proceed?",
    questionRu: "Следующий шаг - брейншторм требований. Переходим?",
  ...
  brainstorm: {
    ...
    questionEn: "Next step is writing the implementation plan. Proceed?",
    questionRu: "Следующий шаг - написание плана. Переходим?",
  ...
  plan: {
    ...
    questionEn: "Next step is the plan review loop. Proceed?",
    questionRu: "Следующий шаг - review loop по плану. Переходим?",
  ...
  "plan-review": {
    ...
    questionEn: "Next step is atomizing the plan into an epic and child work items. Proceed?",
    questionRu: "Следующий шаг - разбить план на атомарные задачи и epic. Переходим?",
  ...
  "work-item-atomization": {
    ...
    questionEn: "Next step is bounded provider-safe execution in the current session. Worktree is optional for isolation or parallel sessions. Proceed?",
    questionRu: "Следующий шаг - bounded provider-safe выполнение в текущей сессии. Worktree нужен только для изоляции или параллельных сессий. Переходим?",
  ...
  "worktree-setup": {
    ...
    questionEn: "Next step is a bounded provider-safe run with stop/resume/status controls. Proceed?",
    questionRu: "Следующий шаг - bounded provider-safe запуск со stop/resume/status. Переходим?",
  ...
  execution: {
    ...
    questionEn: "Next step is the review package for this execution wave. Proceed?",
    questionRu: "Следующий шаг - review package по выполненной волне. Переходим?",
  ...
  "wave-review": {
    ...
    questionEn: "Next step is final status and remaining ready/blocked work. Proceed?",
    questionRu: "Следующий шаг - финальный статус и ready/blocked задачи. Переходим?",
