...
const EXPLICIT_SURFACE_RULES = Object.freeze([
  ...
  },
  {
    ...
    required: [
      /Planning Shape/i,
      /Ask one `plan_delivery` question|offer the choice once/i,
      /Current explicit user answer/i,
      /loop-ready/i,
      /create graph from this plan/i,
      /run deeper review/i,
      /NEXT_USER_ACTIONS\[\]/i,
    ],
  },
  {
    ...
    required: [
      ...
      /Current explicit user answer/i,
      /continue from plan to graph creation or optional deeper review until the user chooses/i,
      /NEXT_STEP_HANDOFF/i,
    ],
  },
  {
  ...
  },
  {
    ...
    required: [
      ...
      /Every producer result must also expose `NEXT_USER_ACTIONS\[\]`(?: and a visible Next User Decision)? before progressing/i,
      /Plan\/pre-plan continuation is fail-closed/i,
      /current explicit user answer/i,
      /user-approved graph choice/i,
      /Next User Decision/i,
    ],
  },
  {
    ...
    required: [
      ...
      /Current explicit user answer/i,
      /Explicit user approval for the loop-ready plan/i,
      /Next User Decision/i,
      /If the plan has not been approved as loop-ready, route to `\/supervibe-plan --loop-ready <plan-path>` and stop/i,
      /If atomic work items or an epic do not exist, route to `\/supervibe-loop --atomize-plan <plan-path> --user-approved-plan`/i,
  ...
  },
  {
    ...
    required: [
      /run deeper review/i,
      /Next User Decision/i,
      /After atomization or a dry-run preview, show one user-facing choice card/i,
      /Do not treat `--user-approved-plan` as permission for release/i,
      /Start next ready task/i,
    ],
  },
  {
    file: "skills/autonomous-agent-loop/SKILL.md",
    label: "autonomous loop plan approval gate",
    required: [
      /Plan Approval And User Gate/i,
      /user-approved loop-ready plan or accepted work-item graph/i,
      /current explicit user answer/i,
      /unanswered handoff/i,
      /Reviewer coverage is mandatory before production or release completion/i,
      /Next User Decision/i,
    ],
  },
  {
    file: "skills/subagent-driven-development/SKILL.md",
    label: "subagent plan approval gate",
    required: [
      /Plan Approval And User Gate/i,
      /user-approved loop-ready plan or accepted work-item graph/i,
      /current explicit user answer/i,
      /accepted atomization\/work graph/i,
      /Next User Decision/i,
      /unanswered `NEXT_STEP_HANDOFF`/i,
    ],
  },
  {
    ...
    required: [
      ...
      /current explicit user answer/i,
      /loop-ready plan approval/i,
      /reviewer coverage for final review\/release/i,
      /Next User Decision/i,
    ],
  },
  {
