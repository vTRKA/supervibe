...
const WORKFLOW_RECEIPT_COMMAND_PATTERNS = Object.freeze([
  ...
  /scoped current-run receipts/i,
  /old global receipts/i,
...
const COMMAND_LOOKUP_RULES = Object.freeze([
  ...
  },
  {
    ...
    required: [
      ...
      /requiredAgentIds/i,
      /lowRiskRequiredAgentIds/i,
      /agentSelectionMode/i,
      /availableAgentSources/i,
      /requiredAgentSources/i,
      /callableAgentSources/i,
      /scopedReceiptGateActive/i,
      /scopedReceiptTrust/i,
      /agent-required-blocked/i,
      /hostInvocation\.invocationId/i,
      /codex-spawn-agent/i,
      /CODEX_SPAWN_PAYLOAD_RULES/i,
  ...
  {
    file: "scripts/supervibe-stage.mjs",
    label: "shared stage runner",
    required: [
      /SUPERVIBE_STAGE_RUN/i,
      /runStage/i,
      /supervibe-stage\.mjs run/i,
      /host-invocation-id/i,
      /issueWorkflowInvocationReceipt/i,
      /validateWorkflowReceipts/i,
  ...
  },
  {
    ...
    required: [
      ...
      /validate:workflow-receipts/i,
      /validate:agent-producer-receipts/i,
      /scoped current-run receipt/i,
      /old global receipts/i,
      /hostInvocation\.source/i,
      /hostInvocation\.invocationId/i,
      /Do not substitute a command receipt/i,
      /validate-design-agent-receipts\.mjs/i,
      /mutable or log-like output artifacts/i,
      /stable per-agent output JSON/i,
      /idempotent/i,
      /NEXT_SAFE_ACTION/i,
      /rebuild-ledger --prune-stale/i,
    ],
  },
  {
    file: "rules/operational-safety.md",
    label: "shared read-only mutation contract",
    required: [
      /Read-only Command Contract/i,
      /MUTATED: <path>/i,
      /Quiet timestamp refreshes/i,
      /--refresh-\*/i,
      /default path no-write/i,
    ],
  },
]);
