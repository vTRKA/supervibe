...
const RULES = Object.freeze([
  ...
  },
  {
    ...
    forbidden: [
      /Approve plan for review/i,
      new RegExp(["mandatory review", "loop"].join(" "), "i"),
      /review loop before atomization/i,
      /plan review must pass.*before atomization/i,
    ],
  },
  {
  ...
  },
  {
    ...
    required: [
      ...
      /workflowSignal/i,
      /NEXT_USER_ACTIONS\[\]/i,
      /Revise graph|Revise atomization/i,
      ...TOPIC_DRIFT_REQUIRED,
    ],
    forbidden: [],
  },
